...
def build_paths(out_dir: str) -> Paths:
    ...
    return Paths(
        out_dir=out_dir,
        model_path=os.path.join(out_dir, "ppo_breakout_pixels.zip"),
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default=r".\runs\breakout_pixels_ppo")
    ...
    def env_fn():
        return make_breakout_pixels_env(
            render_mode=None,
